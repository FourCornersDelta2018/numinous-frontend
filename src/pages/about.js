            ...
            <div className="about">
              ...
              <section>
                <div className="column-y">
                  <img id="Sarah" src="/assets/teamphotos/SarahProctor.jpg" alt="Headshot woman"/>
                  <h3>Sarah Proctor</h3>
                ...
                <div className="column-y">
                  <img id="Kevin" src="/assets/teamphotos/KevinKochanski.jpg" alt="Headshot man"/>
              ...
              <section>
                <div className="column-y">
                  <img id="Tricia" src="/assets/teamphotos/TriciaSykes.jpg" alt="Headshot woman"/>
                  <h3>Tricia Sykes</h3>
                ...
                <div className="column-y">
                  <img id="CJ" src="/assets/teamphotos/CaitlinJohnson.jpg" alt="Headshot woman"/>
